...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://aczjc9yqfh.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.photosObjectPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['object', 'Content-Type', 'x-amz-meta-customLabels', 'x-api-key'], ['body']);
        ...
        var photosObjectPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Content-Type', 'x-amz-meta-customLabels', 'x-api-key']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
